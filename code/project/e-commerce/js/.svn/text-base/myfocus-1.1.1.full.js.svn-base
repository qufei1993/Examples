/*
* myFocus JavaScript Library v1.1.1
...
(function(){
	myFocus={
		defConfig:{trigger:'click',txtHeight:'default',wrap:true,auto:true,delay:100},pattern:{},
		extend:function(){
